...
//    Booking findByItemIdAndEndBeforeOrderByEndDesc(Long itemId, LocalDateTime end);
    Booking findTopByItemIdAndEndBeforeOrderByEndDesc(Long itemId, LocalDateTime end);
